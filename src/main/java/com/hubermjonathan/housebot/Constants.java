...
public class Constants {
    ...
    public static final String MAIN_TEXT_CHANNEL_TOPIC = "for chatting with the residents of the house";
    ...
    public static final String MOVIE_VOICE_CHANNEL_NAME = "home theater";

    public static final String ROOMS_CATEGORY_NAME = "__________🚪__________";
    public static final String ROOM_TEXT_CHANNEL_TOPIC = "for controlling your room";
    public static final String ROOM_CONTROLS_TITLE = "controls";
    public static final String ROOM_CONTROLS_MESSAGE = "```✊: knock on door\n🔒: lock door\n🔑: unlock door\n✌: empty room\n🔥: house fire```";
}
